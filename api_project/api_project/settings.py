...
SECRET_KEY = 'django-insecure-9yul#9u2k-7qs%ybz4t+so!$xt_2)%m79-!sq(j$^3@%dn)9a)'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication',  # Enables session-based auth (optional)
    ],
